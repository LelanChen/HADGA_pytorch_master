...
from models.HADGA_without_T.model import *
...
model = HADGA_without_T(num_features, num_edge_features, cfg.use_edge)
model.to(device)
...
def test():
    ...
    if torch.cuda.is_available():
        ...
        device = torch.device("cpu")
    loaded_model = HADGA_without_T(num_features, num_edge_features, cfg.use_edge)
